...
export interface RoomSceneVideoProps {
...
/**
 * RoomSceneVideo - Displays the room scene / reunion video with loading states
 * Waits for sufficient buffer before playing to prevent lag
 */
export function RoomSceneVideo({
  className,
}: RoomSceneVideoProps): JSX.Element {
